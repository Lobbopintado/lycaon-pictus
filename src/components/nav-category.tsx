    ...
    <>
      ...
      {toggled && (
        <motion.nav
          ...
          className='flex flex-col fixed h-screen bg-white w-screen text-black bottom-0 left-0 gap-6 items-center justify-center z-50 md:hidden list-inside'
        >
            ...
            CATEGORY.map((cat) => (
              <li key={cat} className='p-2'>
                <button
                  ...
                  className={`text-xl leading-6 font-jost text-primary-200 ${cat === category && 'border-b-4 border-solid border-black'}`}
                >
                  {cat.toUpperCase()}
                </button>
              </li>
